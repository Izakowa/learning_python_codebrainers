ui1 = input("wprowadz odp")
print("odpowiedz:", ui1)

ui1 = int(input("Wprowadz swoja odpowiedz: "))
print("Twoja odpowiedz to", ui1, "odpowiedz jest typu", type(ui1))

print("Zadanie 3: Konwersja temperatury ze stopni Fahrenheita na stopnie Celcjusza i Kelvina")
temp_fahr = 100                 # Przykładowa temperatura w stopniach Fahrenheita
